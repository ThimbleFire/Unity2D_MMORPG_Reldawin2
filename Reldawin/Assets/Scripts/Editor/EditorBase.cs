...
namespace AlwaysEast
{
    public class EditorBase : EditorWindow
    {
        ...
        protected void AddRow( int mul = 1 ) {
            Y += 22 * mul; EditorGUILayout.Space( 22 * mul, true );
        }
        ...
        private void PaintBackButton() {
            if( PaintButton( "Back" ) ) { WindowState = WindowStates.Main; Loaded = false; }
        }
